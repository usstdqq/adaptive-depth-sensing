...
parser.add_argument('--path_to_tensorboard_log', type=str, default="tensorBoardRuns/NetM-SP-FusionNet-linear-bilinear-clip-batch-8-240x960-crop-default-epoch-100-lr-00001-decay-slic-w-0000001-pos-w-1-proj-w-0-fix-temp-1-k-5-ADAM-SGD-c-00025-L1-loss-simple-depth-weight-04-03-2021", help='path to tensorboard logging')
...
def val(epoch):
    ...
    for batch in val_loader:
        ...
        with torch.no_grad():
            restored_depth, lidar_out, precise, guide, = modelME.module.netE(sparse_d_rgb_input)
...
def val_rand(epoch):
    ...
    for batch in val_loader:
        ...
        with torch.no_grad():
            depth_prediction, lidar_out, precise, guide, = modelME.module.netE(sparse_d_rgb_input)
